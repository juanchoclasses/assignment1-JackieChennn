...
/**
 * This class evaluates a formula and stored the result.
 */
export class FormulaEvaluator {
  ...
  /**
   * Create the FormulaEvaluator instance with the provided SheetMemory instance.
   * @param memory 
   */
   ...
   * @param expected 
   */
  private matchToken(expected: TokenType): void {
